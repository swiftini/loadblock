...
export default class ResourcesMenu extends Component {
    ...
    state = { activeItem: 'How to Inveth' }
    ...
    render() {
        ...
        return (
            ...
            <Menu vertical>
                <Menu.Item>
                    <Menu.Header color='teal'>Introduction</Menu.Header>

                    <Menu.Menu>
                        <Menu.Item name='How to Inveth' active={activeItem === 'How to Inveth'} onClick={this.handleItemClick} />
